    ...
    public class AreaRepository
    {
        ...
        public bool InsertArea(Area area)
        {
            try
            {
                using (SqlConnection conn = new SqlConnection(_connectionString))
                {
                    ...
                    string query = "INSERT INTO Area_Master (Area_name, Area_type) VALUES (@Area_name, @Area_type)";
        ...
        public Area GetAreaById(int id)
        {
            ...
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                string query = "SELECT Id, Area_name, Area_type FROM Area_Master WHERE Id = @Id";
                SqlCommand cmd = new SqlCommand(query, conn);
        ...
        public bool UpdateArea(Area area)
        {
            using (SqlConnection conn = new SqlConnection(_connectionString))
            {
                ...
                string query = "UPDATE Area_Master SET Area_name = @Area_name, Area_type = @Area_type WHERE Id = @Id";
                SqlCommand cmd = new SqlCommand(query, conn);
